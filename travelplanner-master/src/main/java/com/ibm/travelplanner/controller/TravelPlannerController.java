...
public class TravelPlannerController {
	...
	@PostMapping(value="/city/{subType}/{cityShortCode}")
	public ResponseEntity<CitySearchResponseDTO> citySearch(@PathVariable(value = "subType") String subType, @PathVariable(value = "cityShortCode") String cityShortCode) {			
